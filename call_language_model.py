...
#本地transform加载,适用Qwen3
class LocalModel(BaseModel):
    def __init__(self, credentials: Dict):
        super().__init__(credentials)
        from transformers import AutoTokenizer, AutoModelForCausalLM
        self.tokenizer = AutoTokenizer.from_pretrained(credentials.get('model_name', ''))
        self.model = AutoModelForCausalLM.from_pretrained(credentials.get('model_name', '')).to("cuda")
    ...
    def generate(self, **kwargs):
        ...
        return generated, outputs[0].shape[-1], None
